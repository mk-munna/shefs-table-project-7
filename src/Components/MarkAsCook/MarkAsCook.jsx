...
const MarkAsCook = ({ markedRecipes, updateWantToCook, loadingCook, loadingCooking }) => {
...
MarkAsCook.propTypes = {
    ...
    loadingCook: PropTypes.bool.isRequired,
    loadingCooking: PropTypes.bool.isRequired
